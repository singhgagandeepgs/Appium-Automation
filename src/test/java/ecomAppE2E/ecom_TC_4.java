...
public class ecom_TC_4 extends BaseTest{
	...
	public void testCartTotal() throws InterruptedException {
		...
		String displayedTotalAmtStr = driver.findElement(By.id("com.androidsample.generalstore:id/totalAmountLbl")).getText();
		Double displayedTotalAmt = Double.parseDouble(displayedTotalAmtStr.replace("$", "").trim());
